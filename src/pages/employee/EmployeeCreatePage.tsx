...
export const EmployeeCreatePage: React.FC = () => {
    ...
    const handleSubmit = async (data: EmployeeFormData) => {
        ...
        navigate('/employees'); // Navigate back to the list after creation
    };
    ...
    return (
        <div className="p-4 md:p-6 max-w-4xl mx-auto space-y-6">
            <header>
                ...
                <h1 className="text-3xl font-bold text-gray-800 dark:text-white">Add New Employee</h1>
                <p className="mt-1 text-md text-gray-500 dark:text-gray-400">Fill in the details below to add a new employee to the system.</p>
            </header>
